...
Route::resource('fox.comments', CommentController::class)
    ->only(['store'])
    ->middleware('auth');
...
Route::post('fox/{fox}/like', [FoxLikeController::class, 'like'])
    ->middleware('auth')
    ->name('foxx.like');

Route::post('fox/{fox}/unlike', [FoxLikeController::class, 'unlike'])
    ->middleware('auth')
    ->name('foxx.unlike');
